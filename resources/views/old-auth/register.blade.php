...
<head>
    ...
    <title>Pelaporan Kebersihan GCI - Register</title>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="{{ url('/registration') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="fullname" class="form-control form-control-user @error('fullname') is-invalid @enderror" placeholder="Nama Lengkap" value="{{ old('fullname') }}">
                                            @error('fullname')
