 ...
 *   https://datatables.net/download/#bs4/dt-1.12.1/fh-3.2.4/r-2.3.0/sb-1.3.4/sp-2.0.2
 *
 * Included libraries:
 *   DataTables 1.12.1, FixedHeader 3.2.4, Responsive 2.3.0, SearchBuilder 1.3.4, SearchPanes 2.0.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.12.1/fh-3.2.4/r-2.3.0/sb-1.3.4/sp-2.0.2",
